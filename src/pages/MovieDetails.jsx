...
const MovieDetails = () => {
    ...
    const { poster_path, title, vote_average, release_date, overview, runtime } = movie;

    return (
        <>
            <div className="border-b border-gray-700">
                <div className="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                    <img className="w-96 md:w-64" src={`https://image.tmdb.org/t/p/w500${poster_path}`} alt={title} />
                    ...
                    <div className="md:ml-24">
                        ...
                        <div className="mt-12">
                            ...
                            <div className="flex mt-4">
                                {cast.crew?.slice(0, 2).map((crew) => {
                                    return(
                                        <div className="mr-8" key={crew.id}>
                                            <div>{crew.name}</div>
                                            <div className="text-sm text-gray-400">{crew.known_for_department}</div>
                                        </div>
                                    )
                                })}
                            </div>
